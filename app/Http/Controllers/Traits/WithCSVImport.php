...
trait WithCSVImport
{
    ...
    public function csvStore(Request $request)
    {
        ...
        $storedCsvFile = $csvFile->storeAs('csv_import', sprintf('%s.csv', bin2hex(random_bytes(16))), "public");
    ...
    {
        $path   = storage_path('app/public/csv_import/' . basename($filename));
        ...
        foreach (array_chunk($this->csvContent, 100) as $chunk) {
            $this->csvImportModel::insertOrIgnore($chunk);
        }
